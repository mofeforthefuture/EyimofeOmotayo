  ...
  useEffect(() => {
    ...
    function getWebGLContext(canvas: HTMLCanvasElement) {
      ...
      if (isWebGL2 && gl) {
        ...
        formatRG = getSupportedFormat(gl, gl2.RG16F, gl2.RG, halfFloatTexType || 0);
        formatR = getSupportedFormat(gl, gl2.R16F, gl2.RED, halfFloatTexType || 0);
      } else if (gl) {
        formatRGBA = getSupportedFormat(gl, gl.RGBA, gl.RGBA, halfFloatTexType || 0);
        formatRG = getSupportedFormat(gl, gl.RGBA, gl.RGBA, halfFloatTexType || 0);
        formatR = getSupportedFormat(gl, gl.RGBA, gl.RGBA, halfFloatTexType || 0);
      }
    ...
    function correctRadius(radius: number) {
      let aspectRatio = (canvas?.width || 1) / (canvas?.height || 1);
